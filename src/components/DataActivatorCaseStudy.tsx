        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="p-6 bg-gradient-to-br from-indigo-800/10 to-indigo-800/5 rounded-3xl border-2 border-indigo-800/20">
                <div className="flex items-center gap-3 mb-3">
              ...
              <div className="p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl border-2 border-primary/20">
                <div className="flex items-center gap-3 mb-3">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {designPrinciples.map((principle, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-primary-accent/20 to-indigo-800/20 rounded-3xl flex items-center justify-center mb-4">
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="p-6 bg-gray-50 rounded-3xl border-2 border-gray-200">
                  <h5 className="font-semibold text-primary-accent mb-3">Stakeholder Workshop</h5>
                ...
                <div className="p-6 bg-gray-50 rounded-3xl border-2 border-gray-200">
                  <h5 className="font-semibold text-indigo-800 mb-3">Behavioral Analysis</h5>
                ...
                <div className="p-6 bg-gray-50 rounded-3xl border-2 border-gray-200">
                  <h5 className="font-semibold text-primary/100 mb-3">Private Preview Testing</h5>
      ...
      case 'solution':
        return (
          <div className="space-y-8">
            ...
            <motion.div
              className="p-8 bg-gradient-to-br from-indigo-800/5 to-primary-accent/5 rounded-3xl border-2 border-indigo-800/20 mb-12"
              initial={{ opacity: 0, y: 30 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.8, delay: 0.3 }}
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-indigo-800/20 to-primary-accent/20 rounded-3xl flex items-center justify-center">
                  <Lightbulb className="w-6 h-6 text-indigo-800" />
                </div>
                <h4 className="text-2xl font-bold text-gray-700">Design Exploration & Ideation</h4>
              </div>
              ...
              >
                <div className="bg-white rounded-3xl border-2 border-gray-200 p-4 hover:border-gray-300 transition-all duration-300 shadow-lg hover:shadow-xl">
                  <img 
                    ...
                    className="w-full h-auto rounded-3xl border-2 border-indigo-800/20 hover:border-indigo-800/40 transition-all duration-300"
                  />
                </div>
                
                {/* Click to zoom overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-800/5 to-primary-accent/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
                  <div className="bg-indigo-800/90 backdrop-blur-sm rounded-full px-4 py-2 text-white text-sm font-medium">
                    Click to zoom
                  </div>
                </div>
              </div>
            ...
            <motion.div
              className="p-8 bg-gradient-to-br from-primary-accent/5 to-indigo-800/5 rounded-3xl border-2 border-primary-accent/20"
              initial={{ opacity: 0, y: 30 }}
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.8, delay: 0.5 }}
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-primary-accent/20 to-indigo-800/20 rounded-3xl flex items-center justify-center">
                  <Workflow className="w-6 h-6 text-primary-accent" />
                </div>
                <h4 className="text-2xl font-bold text-gray-700">End-to-End User Flow</h4>
              </div>
              ...
              >
                ...
                {/* Click to zoom overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary-accent/5 to-indigo-800/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
                  <div className="bg-indigo-800/90 backdrop-blur-sm rounded-full px-4 py-2 text-white text-sm font-medium">
                    Click to zoom
                  </div>
                </div>
              ...
              <div className="mt-8 p-6 bg-white rounded-3xl border-2 border-gray-200">
                <h5 className="font-semibold text-gray-700 mb-3">Complete 9-Step Workflow</h5>
                <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="mt-12 p-8 bg-gradient-to-br from-primary-accent/10 to-indigo-800/10 rounded-3xl border-2 border-primary-accent/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {keyMetrics.map((metric, index) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-primary-accent/20 to-indigo-800/20 rounded-3xl flex items-center justify-center mx-auto mb-4">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-black mb-6 text-gray-700">
                ...
                <br />
                <span className="text-gray-700">Experience Design</span>
              </h1>
              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-all duration-300 focus:outline-none focus:ring-4 ${
                    activeTab === tab.id
                      ? 'bg-gradient-to-r from-primary-accent to-indigo-800 text-white shadow-lg focus:ring-primary-accent/50'
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-primary to-primary-accent rounded-full font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 justify-center focus:outline-none focus:ring-4 focus:ring-primary/50"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
